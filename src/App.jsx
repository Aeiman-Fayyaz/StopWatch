...
export default function StopWatch() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-black text-white flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8 overflow-hidden">
      ...
      {/* Header - Responsive */}
      <header className="w-full max-w-7xl mb-8 sm:mb-10 lg:mb-12 xl:mb-16 text-center px-4" data-aos="fade-down">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-8 sm:gap-10 lg:gap-12 xl:gap-16 w-full max-w-7xl px-4">
        ...
        >
          ...
          <div className="lg:hidden mt-6 sm:mt-8" data-aos="fade-up" data-aos-delay="400">
            <div className="text-center">
              <div className="text-xl sm:text-2xl text-gray-300 mb-3 font-medium">Current Time</div>
              <div className="flex items-center justify-center space-x-2 sm:space-x-3">
                ...
                <div className="text-2xl sm:text-3xl text-cyan-400 font-bold">:</div>
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold bg-linear-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">
                    {time.minutes}
                  </div>
        ...
        >
          ...
          <div className="hidden lg:block w-full" data-aos="fade-up">
            <div className="bg-linear-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-lg rounded-3xl p-8 lg:p-10 xl:p-12 border border-gray-700/50 shadow-2xl">
              <div className="text-center space-y-4">
                <h2 className="text-xl lg:text-2xl xl:text-3xl text-gray-300 mb-4 lg:mb-6 font-medium">Stopwatch</h2>
                <div className="flex items-baseline justify-center space-x-3 lg:space-x-4 xl:space-x-6">
                  <div className="text-center">
                    ...
                    <div className="text-xs lg:text-sm xl:text-base text-gray-400 mt-2">HOURS</div>
                  </div>
                  <div className="text-3xl lg:text-4xl xl:text-5xl text-cyan-400 font-bold mb-2 lg:mb-3 xl:mb-4">:</div>
                  <div className="text-center">
                    <div className="text-4xl lg:text-5xl xl:text-6xl font-bold bg-linear-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">
                      {time.minutes}
                    </div>
                    <div className="text-xs lg:text-sm xl:text-base text-gray-400 mt-2">MINUTES</div>
                  </div>
                  <div className="text-3xl lg:text-4xl xl:text-5xl text-cyan-400 font-bold mb-2 lg:mb-3 xl:mb-4">:</div>
                  <div className="text-center">
                    <div className="text-4xl lg:text-5xl xl:text-6xl font-bold bg-linear-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">
                    ...
                    <div className="text-xs lg:text-sm xl:text-base text-gray-400 mt-2">SECONDS</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8 w-full" data-aos="fade-up" data-aos-delay="600">
            {/* Play/Resume Button */}
            <button
              onClick={isRunning && !isPaused ? handlePause : isPaused ? handleResume : handleStart}
            ...
            {isRunning && !isPaused && (
              ...
              >
                ...
                <img src={pause} alt="Pause" className="relative w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 mx-auto" />
                <span className="absolute -bottom-6 sm:-bottom-8 left-1/2 transform -translate-x-1/2 text-xs sm:text-sm text-gray-300 whitespace-nowrap">
                  Pause
                </span>
              </button>
            ...
            >
              ...
              <img src={stop} alt="Stop" className="relative w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 mx-auto" />
              <span className="absolute -bottom-6 sm:-bottom-8 left-1/2 transform -translate-x-1/2 text-xs sm:text-sm text-gray-300 whitespace-nowrap">
                Stop
              </span>
            </button>
          ...
          <div className="flex flex-col items-center space-y-3 sm:space-y-4 mt-4 sm:mt-6" data-aos="fade-up" data-aos-delay="800">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm sm:text-base lg:text-lg text-gray-300 font-medium">
                {!isRunning ? 'Ready to Start' : isPaused ? 'Paused' : 'Running...'}
              </span>
            </div>
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 border border-gray-700/50 hover:border-cyan-500/30 transition-all duration-300 hover:scale-105">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-cyan-400">{time.hours}</div>
              <div className="text-xs sm:text-sm lg:text-base text-gray-400 mt-1 sm:mt-2">Hours</div>
              <div className="text-xs text-gray-500 mt-1">{(seconds / 3600).toFixed(2)} total</div>
            </div>
          </div>
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 border border-gray-700/50 hover:border-blue-500/30 transition-all duration-300 hover:scale-105">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-400">{time.minutes}</div>
              <div className="text-xs sm:text-sm lg:text-base text-gray-400 mt-1 sm:mt-2">Minutes</div>
              <div className="text-xs text-gray-500 mt-1">{(seconds / 60).toFixed(2)} total</div>
            </div>
          </div>
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 border border-gray-700/50 hover:border-purple-500/30 transition-all duration-300 hover:scale-105 sm:col-span-2 lg:col-span-1">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-purple-400">{seconds}</div>
              <div className="text-xs sm:text-sm lg:text-base text-gray-400 mt-1 sm:mt-2">Seconds</div>
              <div className="text-xs text-gray-500 mt-1">Click count: {seconds}</div>
            </div>
          </div>
        </div>

        {/* Mobile Control Tips */}
        <div className="lg:hidden mt-6 sm:mt-8 text-center" data-aos="fade-up" data-aos-delay="1200">
          <p className="text-xs sm:text-sm text-gray-400">
            💡 <span className="text-cyan-300">Tap buttons</span> to control the stopwatch
          </p>
      ...
      <footer className="mt-8 sm:mt-10 w-full max-w-3xl text-center px-4" data-aos="fade-up" data-aos-delay="1400">
        <div className="text-xs sm:text-sm text-gray-500">
          <p>Stopwatch v1.0 • Built with React & Tailwind CSS</p>
